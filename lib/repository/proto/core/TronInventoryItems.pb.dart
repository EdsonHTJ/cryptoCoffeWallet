...
class InventoryItems extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InventoryItems', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  InventoryItems copyWith(void Function(InventoryItems) updates) => super.copyWith((message) => updates(message as InventoryItems)) as InventoryItems; // ignore: deprecated_member_use
