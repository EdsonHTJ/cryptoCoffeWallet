...
class PBFTMessage_MsgType extends $pb.ProtobufEnum {
  static const PBFTMessage_MsgType VIEW_CHANGE = PBFTMessage_MsgType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'VIEW_CHANGE');
  static const PBFTMessage_MsgType REQUEST = PBFTMessage_MsgType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REQUEST');
  static const PBFTMessage_MsgType PREPREPARE = PBFTMessage_MsgType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PREPREPARE');
  static const PBFTMessage_MsgType PREPARE = PBFTMessage_MsgType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PREPARE');
  static const PBFTMessage_MsgType COMMIT = PBFTMessage_MsgType._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'COMMIT');
...
class PBFTMessage_DataType extends $pb.ProtobufEnum {
  static const PBFTMessage_DataType BLOCK = PBFTMessage_DataType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BLOCK');
  static const PBFTMessage_DataType SRL = PBFTMessage_DataType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SRL');
