...
class AccountCreateContract extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountCreateContract', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol'), createEmptyInstance: create)
    ...
    ..e<$2.AccountType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $2.AccountType.Normal, valueOf: $2.AccountType.valueOf, enumValues: $2.AccountType.values)
  ...
  'Will be removed in next major version')
  AccountCreateContract copyWith(void Function(AccountCreateContract) updates) => super.copyWith((message) => updates(message as AccountCreateContract)) as AccountCreateContract; // ignore: deprecated_member_use
...
class AccountUpdateContract extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountUpdateContract', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccountUpdateContract copyWith(void Function(AccountUpdateContract) updates) => super.copyWith((message) => updates(message as AccountUpdateContract)) as AccountUpdateContract; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SetAccountIdContract extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetAccountIdContract', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetAccountIdContract copyWith(void Function(SetAccountIdContract) updates) => super.copyWith((message) => updates(message as SetAccountIdContract)) as SetAccountIdContract; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AccountPermissionUpdateContract extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountPermissionUpdateContract', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerAddress', $pb.PbFieldType.OY)
    ..aOM<$2.Permission>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'owner', subBuilder: $2.Permission.create)
    ..aOM<$2.Permission>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'witness', subBuilder: $2.Permission.create)
    ..pc<$2.Permission>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actives', $pb.PbFieldType.PM, subBuilder: $2.Permission.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AccountPermissionUpdateContract({
    $core.List<$core.int>? ownerAddress,
    $2.Permission? owner,
    $2.Permission? witness,
    $core.Iterable<$2.Permission>? actives,
  }) {
    final _result = create();
    if (ownerAddress != null) {
      _result.ownerAddress = ownerAddress;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccountPermissionUpdateContract copyWith(void Function(AccountPermissionUpdateContract) updates) => super.copyWith((message) => updates(message as AccountPermissionUpdateContract)) as AccountPermissionUpdateContract; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
