...
final $typed_data.Uint8List transactionBalanceTraceDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List blockBalanceTraceDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List accountTraceDescriptor = $convert.base64Decode('CgxBY2NvdW50VHJhY2USGAoHYmFsYW5jZRgBIAEoA1IHYmFsYW5jZRIgCgtwbGFjZWhvbGRlchhjIAEoA1ILcGxhY2Vob2xkZXI=');
...
final $typed_data.Uint8List accountIdentifierDescriptor = $convert.base64Decode('ChFBY2NvdW50SWRlbnRpZmllchIYCgdhZGRyZXNzGAEgASgMUgdhZGRyZXNz');
...
final $typed_data.Uint8List accountBalanceRequestDescriptor = $convert.base64Decode('ChVBY2NvdW50QmFsYW5jZVJlcXVlc3QSSgoSYWNjb3VudF9pZGVudGlmaWVyGAEgASgLMhsucHJvdG9jb2wuQWNjb3VudElkZW50aWZpZXJSEWFjY291bnRJZGVudGlmaWVyElYKEGJsb2NrX2lkZW50aWZpZXIYAiABKAsyKy5wcm90b2NvbC5CbG9ja0JhbGFuY2VUcmFjZS5CbG9ja0lkZW50aWZpZXJSD2Jsb2NrSWRlbnRpZmllcg==');
...
final $typed_data.Uint8List accountBalanceResponseDescriptor = $convert.base64Decode('ChZBY2NvdW50QmFsYW5jZVJlc3BvbnNlEhgKB2JhbGFuY2UYASABKANSB2JhbGFuY2USVgoQYmxvY2tfaWRlbnRpZmllchgCIAEoCzIrLnByb3RvY29sLkJsb2NrQmFsYW5jZVRyYWNlLkJsb2NrSWRlbnRpZmllclIPYmxvY2tJZGVudGlmaWVy');
