...
final $typed_data.Uint8List buyStorageBytesContractDescriptor = $convert.base64Decode('ChdCdXlTdG9yYWdlQnl0ZXNDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgMUgxvd25lckFkZHJlc3MSFAoFYnl0ZXMYAiABKANSBWJ5dGVz');
...
final $typed_data.Uint8List buyStorageContractDescriptor = $convert.base64Decode('ChJCdXlTdG9yYWdlQ29udHJhY3QSIwoNb3duZXJfYWRkcmVzcxgBIAEoDFIMb3duZXJBZGRyZXNzEhQKBXF1YW50GAIgASgDUgVxdWFudA==');
...
final $typed_data.Uint8List sellStorageContractDescriptor = $convert.base64Decode('ChNTZWxsU3RvcmFnZUNvbnRyYWN0EiMKDW93bmVyX2FkZHJlc3MYASABKAxSDG93bmVyQWRkcmVzcxIjCg1zdG9yYWdlX2J5dGVzGAIgASgDUgxzdG9yYWdlQnl0ZXM=');
...
final $typed_data.Uint8List updateBrokerageContractDescriptor = $convert.base64Decode('ChdVcGRhdGVCcm9rZXJhZ2VDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgMUgxvd25lckFkZHJlc3MSHAoJYnJva2VyYWdlGAIgASgFUglicm9rZXJhZ2U=');
