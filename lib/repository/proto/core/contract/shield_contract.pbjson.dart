...
final $typed_data.Uint8List authenticationPathDescriptor = $convert.base64Decode('ChJBdXRoZW50aWNhdGlvblBhdGgSFAoFdmFsdWUYASADKAhSBXZhbHVl');
...
final $typed_data.Uint8List merklePathDescriptor = $convert.base64Decode('CgpNZXJrbGVQYXRoEk8KFGF1dGhlbnRpY2F0aW9uX3BhdGhzGAEgAygLMhwucHJvdG9jb2wuQXV0aGVudGljYXRpb25QYXRoUhNhdXRoZW50aWNhdGlvblBhdGhzEhQKBWluZGV4GAIgAygIUgVpbmRleBIOCgJydBgDIAEoDFICcnQ=');
...
final $typed_data.Uint8List outputPointDescriptor = $convert.base64Decode('CgtPdXRwdXRQb2ludBISCgRoYXNoGAEgASgMUgRoYXNoEhQKBWluZGV4GAIgASgFUgVpbmRleA==');
...
final $typed_data.Uint8List outputPointInfoDescriptor = $convert.base64Decode('Cg9PdXRwdXRQb2ludEluZm8SNAoKb3V0X3BvaW50cxgBIAMoCzIVLnByb3RvY29sLk91dHB1dFBvaW50UglvdXRQb2ludHMSGwoJYmxvY2tfbnVtGAIgASgFUghibG9ja051bQ==');
...
final $typed_data.Uint8List pedersenHashDescriptor = $convert.base64Decode('CgxQZWRlcnNlbkhhc2gSGAoHY29udGVudBgBIAEoDFIHY29udGVudA==');
...
final $typed_data.Uint8List incrementalMerkleTreeDescriptor = $convert.base64Decode('ChVJbmNyZW1lbnRhbE1lcmtsZVRyZWUSKgoEbGVmdBgBIAEoCzIWLnByb3RvY29sLlBlZGVyc2VuSGFzaFIEbGVmdBIsCgVyaWdodBgCIAEoCzIWLnByb3RvY29sLlBlZGVyc2VuSGFzaFIFcmlnaHQSMAoHcGFyZW50cxgDIAMoCzIWLnByb3RvY29sLlBlZGVyc2VuSGFzaFIHcGFyZW50cw==');
...
final $typed_data.Uint8List incrementalMerkleVoucherDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List incrementalMerkleVoucherInfoDescriptor = $convert.base64Decode('ChxJbmNyZW1lbnRhbE1lcmtsZVZvdWNoZXJJbmZvEj4KCHZvdWNoZXJzGAEgAygLMiIucHJvdG9jb2wuSW5jcmVtZW50YWxNZXJrbGVWb3VjaGVyUgh2b3VjaGVycxIUCgVwYXRocxgCIAMoDFIFcGF0aHM=');
...
final $typed_data.Uint8List spendDescriptionDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List receiveDescriptionDescriptor = $convert.base64Decode('ChJSZWNlaXZlRGVzY3JpcHRpb24SKQoQdmFsdWVfY29tbWl0bWVudBgBIAEoDFIPdmFsdWVDb21taXRtZW50EicKD25vdGVfY29tbWl0bWVudBgCIAEoDFIObm90ZUNvbW1pdG1lbnQSEAoDZXBrGAMgASgMUgNlcGsSEwoFY19lbmMYBCABKAxSBGNFbmMSEwoFY19vdXQYBSABKAxSBGNPdXQSGAoHemtwcm9vZhgGIAEoDFIHemtwcm9vZg==');
...
final $typed_data.Uint8List shieldedTransferContractDescriptor = $convert.base64Decode('');
