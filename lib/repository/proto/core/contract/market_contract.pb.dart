...
class MarketSellAssetContract extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MarketSellAssetContract', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol'), createEmptyInstance: create)
  ...
  factory MarketSellAssetContract.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MarketSellAssetContract.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  MarketSellAssetContract copyWith(void Function(MarketSellAssetContract) updates) => super.copyWith((message) => updates(message as MarketSellAssetContract)) as MarketSellAssetContract; // ignore: deprecated_member_use
  ...
  static $pb.PbList<MarketSellAssetContract> createRepeated() => $pb.PbList<MarketSellAssetContract>();
  @$core.pragma('dart2js:noInline')
  static MarketSellAssetContract getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MarketSellAssetContract>(create);
...
class MarketCancelOrderContract extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MarketCancelOrderContract', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerAddress', $pb.PbFieldType.OY)
  ...
  factory MarketCancelOrderContract.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MarketCancelOrderContract.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MarketCancelOrderContract copyWith(void Function(MarketCancelOrderContract) updates) => super.copyWith((message) => updates(message as MarketCancelOrderContract)) as MarketCancelOrderContract; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MarketCancelOrderContract create() => MarketCancelOrderContract._();
  MarketCancelOrderContract createEmptyInstance() => create();
  static $pb.PbList<MarketCancelOrderContract> createRepeated() => $pb.PbList<MarketCancelOrderContract>();
  @$core.pragma('dart2js:noInline')
  static MarketCancelOrderContract getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MarketCancelOrderContract>(create);
