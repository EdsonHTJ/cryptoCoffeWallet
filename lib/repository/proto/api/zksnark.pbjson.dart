...
final $typed_data.Uint8List zksnarkRequestDescriptor = $convert.base64Decode('Cg5aa3NuYXJrUmVxdWVzdBI3Cgt0cmFuc2FjdGlvbhgBIAEoCzIVLnByb3RvY29sLlRyYW5zYWN0aW9uUgt0cmFuc2FjdGlvbhIYCgdzaWdoYXNoGAIgASgMUgdzaWdoYXNoEiIKDHZhbHVlQmFsYW5jZRgDIAEoA1IMdmFsdWVCYWxhbmNlEhIKBHR4SWQYBCABKAlSBHR4SWQ=');
@$core.Deprecated('Use zksnarkResponseDescriptor instead')
const ZksnarkResponse$json = const {
  '1': 'ZksnarkResponse',
  '2': const [
    const {'1': 'code', '3': 1, '4': 1, '5': 14, '6': '.protocol.ZksnarkResponse.Code', '10': 'code'},
  ],
...
final $typed_data.Uint8List zksnarkResponseDescriptor = $convert.base64Decode('Cg9aa3NuYXJrUmVzcG9uc2USMgoEY29kZRgBIAEoDjIeLnByb3RvY29sLlprc25hcmtSZXNwb25zZS5Db2RlUgRjb2RlIh8KBENvZGUSCwoHU1VDQ0VTUxAAEgoKBkZBSUxFRBAB');
